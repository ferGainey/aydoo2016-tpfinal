...
class Choque
  ...
  def cargo_los_efectos_a_la_fila_de_la_nave
    ...
    return choques_de_la_nave
  end

  def cargo_los_efectos_a_la_fila_del_misil
    ...
    return choques_del_misil
  end

  def cargo_los_efectos_a_la_fila_de_la_bomba
    ...
    return choques_de_la_bomba
  end

  def cargo_los_efectos_a_la_fila_del_asteroide
    ...
    return choques_del_asteroide
  end

  def cargo_los_efectos_a_la_fila_de_la_estrella
